...
const Toast = ({ msg }) => (
  <div className="fixed top-5 right-5 z-[200] flex items-center gap-3 px-5 py-4 rounded-xl shadow-2xl bg-green-600 text-white text-sm font-semibold max-w-xs pointer-events-none">
...
// ─── Main Component: Email Template Previewer (SYS-MAIL-01) ──────────────────────
...
const EmailTemplatePreviewer = () => {
  ...
  const handleSendTest = () => {
    setToast({ visible: true, msg: `Đã gửi email test thành công đến ${vars.username || "địa chỉ mặc định"}!` });
  };
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-gray-100">
      ...
      {/* ── App Header ── */}
      <header className="bg-white border-b border-gray-200 shadow-sm flex-shrink-0 px-6 py-3.5 flex items-center justify-between gap-4">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Left: Control panel */}
        <div className="w-[30%] min-w-[260px] max-w-[340px] flex-shrink-0 flex flex-col overflow-hidden">
